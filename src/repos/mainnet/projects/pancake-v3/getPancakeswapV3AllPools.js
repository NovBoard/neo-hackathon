...
// const endpoint = "https://api.thegraph.com/subgraphs/name/pancakeswap/exchange-v3-eth"

// graphql-request를 사용하여 pool 정보를 가져오는 함수
async function getPancakeswapV3AllPools(walletAddress) {
    // graphql 쿼리
    const query = gql`
    {
...
export {getPancakeswapV3AllPools}